...
/*<----------------###### PHP Regex  ######------------------>*/
	...
	// => There must be a word, an "@" another word, a "." and 2 to 8 letters (because nowadays domain extension can be .science or .computer)
	mailRegex = "#^[\w.-]+@[\w.-]+\.[a-z]{2,8}$#i";

	// PASSWORD Regex which matchs a password from 8 to 25 characters. There must be at least one number and one capital letter 
	// You can also check for at least one small letter with "(?=.*[a-z])" but I don't estimate it as usefull
...
p{L} means all letters, including accented letters and specific letters like "ß".
p{L} cannot be used in JS so we have to declare it by hands
"áàâäãåæçéèêëíìîïñøóòôöõúùûüýÿÆÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑØÓÒÔÖÕÚÙÛÜÝŸß" should cover every specific letters (from Latin, to germanic and also nordic)
